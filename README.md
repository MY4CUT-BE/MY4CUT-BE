...
**My4Cut**은 인생네컷 사진을 단순 저장이 아닌  
**기록 · 정리 · 협업 · 선택**까지 가능하도록 설계된 서비스입니다.

사용자는 친구를 추가하고 워크스페이스에 초대하여  
촬영한 인생네컷을 업로드한 뒤, 서로 댓글로 의견을 나누고  
최종본을 함께 선택할 수 있습니다.

또한, 갤러리에 흩어져 있는 사진들을  
체계적으로 관리할 수 있도록 다양한 관리 기능을 제공합니다.

> 단순한 사진 저장이 아닌  
> **"함께 고르고, 함께 기록하는 인생네컷 경험"** 을 제공합니다.
