...
public enum WorkspaceErrorCode implements BaseCode {
    ...
    INVITATION_NOT_FOUND(HttpStatus.NOT_FOUND, "W4045", "존재하지 않는 워크스페이스 초대입니다."),
    WORKSPACE_USER_NOT_FOUND(HttpStatus.NOT_FOUND, "W4046", "워크스페이스 작업 대상 사용자를 찾을 수 없습니다."),
    ...
    INVITATION_ALREADY_PROCESSED(HttpStatus.BAD_REQUEST, "W4002", "이미 처리된 워크스페이스 초대입니다.");
